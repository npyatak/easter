<div class="general-page">
        ...
        <div class="g-container">
            <div class="inner">
                ...
                <div class="text-center">
                    <a href="" class="go-to-second-screen"><span class="fa fa-angle-down"></span></a>
                </div>
            </div>
        </div>
    </div>
    <div class="second-block">
        <div class="top">
            <div class="g-container">
                <div class="text-center"><img class="icon" src="/frontend/web/images/general-page/kulich.png" alt="Kulich"></div>
